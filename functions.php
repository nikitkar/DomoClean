...
add_action('wp_enqueue_scripts', function(){
    ...
    wp_enqueue_style('CottageClining', get_template_directory_uri() . '/assets/style/CottageClining.css');
    wp_enqueue_style('MaintenanceCleaning', get_template_directory_uri() . '/assets/style/MaintenanceCleaning.css');
    wp_deregister_script( 'jquery' );
    wp_register_script( 'jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js%27');
